...
Let us look at the python code and check where the error is present. The hint given makes it easy to narrow it down.
...
let us change the assignment operator to ==
